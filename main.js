...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        this.meninocarrinho.setScale(1); // Define a escala do personagem
            ...
            this.meninocarrinho.on("pointerup", (pointer) => {
                ...
                this.btplayagain = this.add.image(600, 300, "btplayagain").setOrigin(0, 0);
                this.btplayagain.setDisplaySize(400, 130); // Define o tamanho do botão como desejado
                this.btplayagain.setScale(1,1);
                ...
                function calcularPagamentoMinimo(precoProduto, dinheiro) {
                    ...
                    function calcular(pagamentoAtual, indiceMoeda) {
                        ...
                        if (pagamentoAtual >= precoProduto) {
                            pagamentoMinimo = Math.min(pagamentoMinimo, pagamentoAtual);
                            return;
                        }
                ...
                this.okbutton.on('pointerup', function () {
                    ...
                    if (total === melhorPagamento) {
                        ...
                        jogarnovamente.btplayagain.on('pointerdown', function () {
                            jogarnovamente.btplayagain.setScale(1, 0.95); // Diminui o tamanho horizontal do botão ao ser pressionado

                        });

                        jogarnovamente.btplayagain.on('pointerup', function () {
                            jogarnovamente.btplayagain.setScale(1,1); // Retorna o tamanho do botão ao normal ao soltar
